...
def get_wilson_b_matrix(mol : Chem.rdchem.Mol):
    """
    Returns list of internal coords and Wilson B-Matrix
    !!! Rewrites function
    """
    coords_2d = parse_coords_from_mol(mol)        # shape (N, 3)
    coords_flat = coords_2d.flatten()             # shape (3N,)

    int_coords_list = parse_to_internal(mol, coords_2d)
